...
#    for file in files:
nf = open("lists/list"+sys.argv[1]+".dat","r")
for line in nf:
	d = line.split()
#	print d[0:-3]
	os.system("./vina --config conf.txt --ligand ligands/"+d[0][:-4]+"pdbqt --out data03/ligands_coord/"+d[0][:-4]+"pdbqt --log data03/ligands_energies/"+d[0]+".txt --cpu 20")
